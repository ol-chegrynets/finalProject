...
def compare_cards(cards_player_1, cards_player_2):  # порівняти карти на роздачі
    ...
    rank_cards_wight = {"six": 60, "seven": 70, "eight": 80, "nine": 90, "ten": 100, "jack": 110, "queen": 120,
                        "king": 130, "ace": 140}

    if (rank_cards_wight.get(cards_player_1[0]) + rank_suit.get(cards_player_1[1])) > (
            rank_cards_wight.get(cards_player_2[0]) + rank_suit.get(cards_player_2[1])):
